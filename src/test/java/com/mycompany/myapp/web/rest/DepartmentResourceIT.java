...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        return new Department().departmentName(DEFAULT_DEPARTMENT_NAME).address(DEFAULT_ADDRESS);
    }
    ...
    public static Department createUpdatedEntity() {
        return new Department().departmentName(UPDATED_DEPARTMENT_NAME).address(UPDATED_ADDRESS);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).address(UPDATED_ADDRESS);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).address(UPDATED_ADDRESS);
