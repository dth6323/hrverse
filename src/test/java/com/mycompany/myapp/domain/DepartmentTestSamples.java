...
public class DepartmentTestSamples {
    ...
    public static Department getDepartmentSample1() {
        return new Department().id(1L).departmentName("departmentName1").address("address1");
    }

    public static Department getDepartmentSample2() {
        return new Department().id(2L).departmentName("departmentName2").address("address2");
    }
