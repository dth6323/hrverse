...
export class ResignationComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.resignations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IResignation[] | null): IResignation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.resignationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
