...
export class AttendanceComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.attendances = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAttendance[] | null): IAttendance[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.attendanceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
