...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../attendance.test-samples';

import { AttendanceService, RestAttendance } from './attendance.service';

const requireRestSample: RestAttendance = {
  ...sampleWithRequiredData,
  dateOfwork: sampleWithRequiredData.dateOfwork?.format(DATE_FORMAT),
  checkInTime: sampleWithRequiredData.checkInTime?.toJSON(),
  checkOutTime: sampleWithRequiredData.checkOutTime?.toJSON(),
};
